...
function SoundManager(smURL,smID) {
  ...
  this._createMovie = function(smID,smURL) {
    ...
    if (_s.isIE) {
      ...
      oMovie = document.createElementNS('http://www.w3.org/1999/xhtml','embed');
      for (tmp in oEmbed) {
    ...
    var oD = document.createElementNS('http://www.w3.org/1999/xhtml','div');
    ...
    if (oTarget) {
      ...
      _s.oMC = document.getElementById('sm2-container')?document.getElementById('sm2-container'):document.createElementNS('http://www.w3.org/1999/xhtml','div');
      ...
      if (!document.getElementById(_s.debugID) && ((!_s._hasConsole||!_s.useConsole)||(_s.useConsole && _s._hasConsole && !_s.consoleOnly))) {
        var oDebug = document.createElementNS('http://www.w3.org/1999/xhtml','div');
  ...
  this._writeDebug = function(sText,sType,bTimestamp) {
    ...
    try {
      ...
      var oItem = document.createElementNS('http://www.w3.org/1999/xhtml','div');
      // sText = sText.replace(/\n/g,'<br />');
